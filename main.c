...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LEFT_VOLTAGE 3.91
#define RIGHT_VOLTAGE 3.96
/* USER CODE END PD */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, D_C_SPI1_Pin|RES__SPI1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : D_C_SPI1_Pin RES__SPI1_Pin */
  GPIO_InitStruct.Pin = D_C_SPI1_Pin|RES__SPI1_Pin;
